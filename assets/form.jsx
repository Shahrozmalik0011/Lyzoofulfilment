...
function LeadFormEngine() {
  ...
  const submitToFormspree = async () => {
    ...
    try {
      ...
      if (json.success) { try { localStorage.removeItem(LS_KEY); } catch {} setDone(true); }
